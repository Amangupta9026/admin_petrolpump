...
class CustomDateScreen extends ConsumerStatefulWidget {
  final String? selectedDate;
  const CustomDateScreen({this.selectedDate, super.key});

  @override
  ConsumerState<CustomDateScreen> createState() => _CustomDateScreen();
}

class _CustomDateScreen extends ConsumerState<CustomDateScreen> {
  void checkLogin() {
  ...
  Widget build(BuildContext context) {
    ...
    // custom date
    DateTime custom = DateTime.parse(widget.selectedDate.toString());
    print(custom);
    return Scaffold(
